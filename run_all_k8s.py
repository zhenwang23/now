...
gateway_host, gateway_port, gateway_host_internal, gateway_port_internal = run_backend.run(user_input, is_debug)
frontend_host, frontend_port = run_frontend.run(user_input.dataset, gateway_host, gateway_port, gateway_host_internal, gateway_port_internal, docker_frontend_tag)
